...
1. Launches yt-dlp  
2. Monitors the last 120 lines of output  
3. Counts occurrences of known error patterns  
4. If 10+ matches occur within that window:
   - Terminates yt-dlp  
   - Waits briefly  
   - Restarts it automatically  
5. Continues until the download completes successfully  
